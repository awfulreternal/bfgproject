...
print('!!! СОЗДАН ПРОМОКОД "промо #сновымгодом". Для удаление промокода удалите файл ptomo.py из папки modules.')
...
def register_handlers(dp: Dispatcher):
    ...
    dp.register_message_handler(promo_start, lambda message: message.text.lower().startswith('промо #сновымгодом'))